...
import {reqeust, postReqeust,getReqeust} from '../request.js'
...
export const getGanHuo  = params => getReqeust('/data/category/GanHuo/type/Android/page/'+params[0]+'/count/'+params[1]);
//
// {
